...
const emptyAddress = Object.freeze({ postalCode: '', address: '', name: '' });
const [getAddresser, setAddresser] = createSignal<AddressModel>({ postalCode: '', address: '', name: '' });
  ...
  onMount(() => {
    sheet = jspreadsheet(element, {
      ...
      columns: [
        ...
        { title: '名前', width: 140, align: 'left', wordWrap: true },
